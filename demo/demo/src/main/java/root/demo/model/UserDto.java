...
public class UserDto {
	...
	public UserDto(Long id, String ime, String prezime, String grad, String drzava, String titula, String email,
			String username, String password, String nOblasti, boolean recenzent, boolean aktiviran, String role) {
		super();
		this.id = id;
		this.ime = ime;
	...
	public String toString() {
		return "UserDto [id=" + id + ", ime=" + ime + ", prezime=" + prezime + ", grad=" + grad + ", drzava=" + drzava
